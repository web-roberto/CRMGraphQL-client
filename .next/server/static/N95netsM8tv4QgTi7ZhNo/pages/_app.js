...
var tslib = __webpack_require__("pPc8");
...
var tsInvariant = __webpack_require__("eC4H");
...
const httpLink = Object(main["createHttpLink"])({
...
// EXTERNAL MODULE: ./context/pedidos/PedidoContext.js
var PedidoContext = __webpack_require__("tu9Y");
...
// CONCATENATED MODULE: ./context/pedidos/PedidoReducer.js
function PedidoReducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function PedidoReducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? PedidoReducer_ownKeys(Object(source), !0).forEach(function (key) { PedidoReducer_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : PedidoReducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }

function PedidoReducer_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


/* harmony default export */ var PedidoReducer = ((state, action) => {
  switch (action.type) {
    case SELECCIONAR_CLIENTE:
      return PedidoReducer_objectSpread({}, state, {
...
// CONCATENATED MODULE: ./context/pedidos/PedidoState.js
var __jsx = external_react_default.a.createElement;

function PedidoState_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function PedidoState_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? PedidoState_ownKeys(Object(source), !0).forEach(function (key) { PedidoState_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : PedidoState_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }

function PedidoState_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const PedidoState = ({
  ...
  const {
    0: state,
    1: dispatch
  } = Object(external_react_["useReducer"])(PedidoReducer, initialState); // Modifica el Cliente
  ...
  const agregarProducto = productosSeleccionados => {
    ...
    if (state.productos.length > 0) {
      ...
      nuevoState = productosSeleccionados.map(producto => {
        ...
        return PedidoState_objectSpread({}, producto, {}, nuevoObjeto);
      });
    } else {
  ...
  return __jsx(PedidoContext["a" /* default */].Provider, {
    value: {
...
/* harmony default export */ var pedidos_PedidoState = (PedidoState);
...
const MyApp = ({
  ...
  return _app_jsx(main["ApolloProvider"], {
    client: apollo
  }, _app_jsx(pedidos_PedidoState, null, _app_jsx(Component, pageProps)));
};
...
var tsInvariant = __webpack_require__("eC4H");
var process$1 = __webpack_require__("wztu");
var graphql = __webpack_require__("T7Fc");
...
/* harmony default export */ __webpack_exports__["a"] = (PedidoContext);
